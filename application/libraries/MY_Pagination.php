	...
	public function create_links()
	{
		...
		if ($this->first_link !== FALSE && $this->cur_page > ($this->num_links + 1 + ! $this->num_links))
		{
			...
			$output .= $this->first_tag_open.'<a href="'.$first_url.'"'.$attributes.$this->_attr_rel('start').'>'
				.$this->_links_inner.$this->first_link.'</a>'.$this->first_tag_close;
		}
		...
		if ($this->prev_link !== FALSE && $this->cur_page !== 1)
		{
			...
			if ($i === $base_page)
			{
				...
				$output .= $this->prev_tag_open.'<a href="'.$first_url.'"'.$attributes.$this->_attr_rel('prev').'>'
					.$this->_links_inner.$this->prev_link.'</a>'.$this->prev_tag_close;
			}
			else
			{
				...
				if ($i >= $base_page)
				{
					...
					elseif ($i === $base_page)
					{
						...
						$output .= $this->num_tag_open.'<a href="'.$first_url.'"'.$attributes.$this->_attr_rel('start').'>'
							.$this->_links_inner.$loop.'</a>'.$this->num_tag_close;
					}
					else
					{
						$append = $this->prefix.$i.$this->suffix;
		...
		if ($this->next_link !== FALSE && $this->cur_page < $num_pages)
		{
			...
			$output .= $this->next_tag_open.'<a href="'.$base_url.$this->prefix.$i.$this->suffix.'"'.$attributes
				.$this->_attr_rel('next').'>'.$this->_links_inner.$this->next_link.'</a>'.$this->next_tag_close;
		}
		...
		if ($this->last_link !== FALSE && ($this->cur_page + $this->num_links + ! $this->num_links) < $num_pages)
		{
			...
			$output .= $this->last_tag_open.'<a href="'.$base_url.$this->prefix.$i.$this->suffix.'"'.$attributes.'>'
				.$this->_links_inner.$this->last_link.'</a>'.$this->last_tag_close;
		}
